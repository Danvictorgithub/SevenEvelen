      ...
      <div class="lg:flex">
        <div class="w-full -mx-6 lg:w-2/5">
          <div class="px-6">
            ...
            <p class="max-w-sm mt-2 text-gray-500">
              Join 31,000+ other sellers and never miss out on sells, tips, and
              more.
            </p>
            ...
            <div class="flex mt-6 -mx-2">
              <!-- <a
                href="#"
                class="mx-2 text-gray-600 transition-colors duration-300 hover:text-blue-500 :text-blue-400"
                aria-label="Reddit"
              >
                <svg
        ...
        <div class="mt-6 lg:mt-0 lg:flex-1">
          ...
          >
            ...
            <div>
              <h3 class="text-gray-700 uppercase">Franchise</h3>
              <a
                href="#"
                class="block mt-2 text-sm text-gray-600 hover:underline"
                >Qualification</a
